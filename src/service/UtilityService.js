      ...
      await StoryModel.insertMany([
        {
          ...
          imgSrc: `${process.cwd()}/public/story/1.png`,
          steps: [
            {
              imgSrc: `${process.cwd()}/public/story/1-1.png`,
              content:
            ...
            {
              imgSrc: `${process.cwd()}/public/story/1-2.png`,
              content:
            ...
            {
              imgSrc: `${process.cwd()}/public/story/1-3.png`,
              content:
            ...
            {
              imgSrc: `${process.cwd()}/public/story/1-4.png`,
              content:
            ...
            {
              imgSrc: `${process.cwd()}/public/story/1-5.png`,
              content:
